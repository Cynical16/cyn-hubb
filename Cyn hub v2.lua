...
local SpookyWare = Instance.new("TextButton")
...
SpookyWare.Name = "Spooky Ware"
SpookyWare.Parent = TextButton_Roundify_12px_8
SpookyWare.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
SpookyWare.BackgroundTransparency = 1.000
SpookyWare.Position = UDim2.new(0.0330582075, 0, 3.57627869e-07, 0)
SpookyWare.Size = UDim2.new(0, 114, 0, 30)
SpookyWare.Font = Enum.Font.GothamBold
SpookyWare.Text = "SpookyWare"
SpookyWare.TextColor3 = Color3.fromRGB(0, 0, 0)
SpookyWare.TextSize = 18.000
...
SanityHub.MouseButton1Down:connect(function()
	loadstring(game:HttpGet("https://sanityvanity.000webhostapp.com"))()
end)
